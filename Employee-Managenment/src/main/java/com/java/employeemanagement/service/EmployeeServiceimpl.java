...
//	    req.setEmployeeDesignation(employeeDesignationRepository.findById(req.getEmployeeDesignation().getId()).get());
	    
	    
//	    EmployeeDetails empDetails = new EmployeeDetails();
//	    empDetails.setAddress(req.getEmployeeDetails().getAddress());
//	    empDetails.setCity(req.getEmployeeDetails().getCity());
//	    empDetails.setCountry(req.getEmployeeDetails().getCountry());
//	    empDetails.setMotherName(req.getEmployeeDetails().getMotherName());
//	    empDetails.setPincode(req.getEmployeeDetails().getPincode());
//	    empDetails.setFatherName(req.getEmployeeDetails().getFatherName());
//	    
//	    req.setEmployeeDetails(empDetails);
